...
CREATE VIRTUAL TABLE categories_fts USING fts5(name);
INSERT INTO categories_fts(rowid, name) SELECT id, name FROM categories;
...
CREATE VIRTUAL TABLE tags_fts USING fts5(name);
